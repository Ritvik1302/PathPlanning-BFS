...
class MapNode:
    def __init__(self):
        ...
        self.__map = Map(dimensions[0], dimensions[1], (coords[0], coords[1]), (coords[2], coords[3]), self.array)
        ...
        self.print_canvas = tkinter.Canvas(self.print_root, bg="white", height=(100 + self.walls.height * 50),
    ...
    def update_print(self):
        ...
        temp = self.walls
        self.print_canvas.create_rectangle((50 + (temp.end[1] * 50)), (50 + (temp.end[0] * 50)),
                                           (50 + ((temp.end[1] + 1) * 50)), (50 + ((temp.end[0] + 1) * 50)),
                                           fill="#00ff00")
        self.print_canvas.create_rectangle((50 + (self.current[1] * 50)), (50 + (self.current[0] * 50)),
                                           (50 + ((self.current[1] + 1) * 50)), (50 + ((self.current[0] + 1) * 50)),
                                           fill="#0000ff")

        for i in range(temp.width):
            for j in range(temp.height):
                if temp.check_top_wall((j, i)):
                    self.print_canvas.create_line((50 + (i * 50)), (50 + (j * 50)), (50 + ((i + 1) * 50)),
                                                  (50 + (j * 50)), fill="#000000", width=2)

                if temp.check_left_wall((j, i)):
                    self.print_canvas.create_line((50 + (i * 50)), (50 + (j * 50)), (50 + (i * 50)),
                                                  (50 + ((j + 1) * 50)), fill="#000000", width=2)

                if temp.check_right_wall((j, i)):
                    self.print_canvas.create_line((50 + ((i + 1) * 50)), (50 + (j * 50)), (50 + ((i + 1) * 50)),
                                                  (50 + ((j + 1) * 50)), fill="#000000", width=2)

                if temp.check_bottom_wall((j, i)):
                    self.print_canvas.create_line((50 + (i * 50)), (50 + ((j + 1) * 50)), (50 + ((i + 1) * 50)),
                                                  (50 + ((j + 1) * 50)), fill="#000000", width=2)
